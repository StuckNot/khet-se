...
We are currently building the MVP / informational version of KhetSe. The full e-commerce capabilities (cart checkout, order management, user accounts, and admin actions) are not required for this phase. 
...
When KhetSe transitions to the **Live E-Commerce Version**, the following modules must be migrated to the Repository Pattern:
